...
const EstimtestLogo = () => {
  return (hAsync("svg", { class: 'square', style: { '--size': '1.7em' }, viewBox: '0 0 110.07 135.47' },
...
const CloseIcon = () => {
  return (hAsync("svg", { class: 'square', style: { '--size': '1em' }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 67.7 67.7' },
...
const ChevronIcon = ({ direction }) => {
  return (hAsync("svg", { style: { '--size': '1em' }, class: {
...
const coreCss = "/*!@.full-screen*/.full-screen.sc-estimtest-core{position:fixed;width:100%;height:100%;top:0em;pointer-events:none;z-index:1000}/*!@.full-width*/.full-width.sc-estimtest-core{width:100%}/*!@.absolute-bottom*/.absolute-bottom.sc-estimtest-core{position:absolute;bottom:0.5em;left:50%;transform:translateX(-50%)}/*!@.absolute-top*/.absolute-top.sc-estimtest-core{position:absolute;top:0.5em;left:50%;transform:translateX(-50%)}/*!@.absolute-center*/.absolute-center.sc-estimtest-core{position:absolute;top:0.5em;left:50%;top:50%;transform:translateX(-50%) translateY(-50%)}/*!@.flex-row*/.flex-row.sc-estimtest-core{display:flex;align-items:center;gap:0.8em}/*!@.flex-column*/.flex-column.sc-estimtest-core{display:flex;flex-direction:column;align-items:center;gap:0.8em}/*!@.upside-down*/.upside-down.sc-estimtest-core{transform:rotateZ(180deg)}/*!@.bold*/.bold.sc-estimtest-core{font-weight:bold}/*!@.square*/.square.sc-estimtest-core{width:var(--size);height:var(--size)}/*!@.clickable*/.clickable.sc-estimtest-core{cursor:pointer;filter:drop-shadow(0em 0em 0em hsla(0, 0%, 100%, 0.7));transition:filter ease 250ms}/*!@.clickable:hover*/.clickable.sc-estimtest-core:hover{filter:drop-shadow(rgba(255, 255, 255, 0.7) 0em 0em 1em)}/*!@.auto-resize-textarea*/.auto-resize-textarea.sc-estimtest-core{resize:none;overflow:hidden;height:18px}/*!@.will-animate-blur*/.will-animate-blur.sc-estimtest-core{opacity:0;filter:blur(16px);pointer-events:none !important;transition:filter ease 300ms, opacity ease 300ms}/*!@.will-animate-blur.animate-blur*/.will-animate-blur.animate-blur.sc-estimtest-core{pointer-events:all !important;opacity:1;filter:blur(0px)}/*!@.title*/.title.sc-estimtest-core{font-size:1.2em;font-weight:bold;margin:0em;z-index:1000}/*!@.caption*/.caption.sc-estimtest-core{font-size:1.1em;opacity:0.6;margin:0em}/*!@.paragraph*/.paragraph.sc-estimtest-core{margin:0em;opacity:0.9;text-align:left}/*!@.box*/.box.sc-estimtest-core{width:fit-content;max-width:90%;max-height:calc(100% - 3em);padding:0.7em 1.4em;overflow:hidden;border-radius:1em;border-style:solid;border-width:1px;border-color:hsl(0, 0%, 30%);background:linear-gradient(45deg, hsl(0, 0%, 0%), hsl(0, 0%, 10%));color:hsl(0, 0%, 100%);box-shadow:0em 0em 1em 0em hsl(0, 0%, 15%);pointer-events:all}/*!@.button*/.button.sc-estimtest-core{display:flex;padding:0.5em 1em;border-style:solid;border-color:hsl(0, 0%, 20%);border-width:1px;border-radius:1em;background:hsl(0, 0%, 10%);color:hsl(0, 0%, 100%);font-size:0.9em;cursor:pointer}/*!@.button:hover*/.button.sc-estimtest-core:hover{border-color:hsl(0, 0%, 40%)}/*!@.full-screen, button*/.full-screen.sc-estimtest-core,button.sc-estimtest-core{font-family:\"Azeret Mono\", monospace;font-weight:200}/*!@.results-grid*/.results-grid.sc-estimtest-core{gap:0.2em;text-align:left}/*!@.results-grid > **/.results-grid.sc-estimtest-core>*.sc-estimtest-core{padding:0.3em 1em;border-radius:0.5em;border-style:solid;border-width:1px}/*!@.results-grid > *.fail*/.results-grid.sc-estimtest-core>*.fail.sc-estimtest-core{background-color:hsla(0, 100%, 50%, 0.1);border-color:hsl(0, 100%, 50%)}/*!@.results-grid > *.pass*/.results-grid.sc-estimtest-core>*.pass.sc-estimtest-core{background-color:hsla(120, 100%, 30%, 0.1);border-color:hsl(120, 100%, 30%)}/*!@.results-grid > * > *:first-child*/.results-grid.sc-estimtest-core>*.sc-estimtest-core>*.sc-estimtest-core:first-child{max-width:12em;min-width:12em}";
